...
CREATE INDEX IF NOT EXISTS idx_activity_dismissals_lookup ON activity_dismissals(family_id, date);

ALTER TABLE activity_dismissals ENABLE ROW LEVEL SECURITY;

DROP POLICY IF EXISTS "Family can manage dismissals" ON activity_dismissals;
...
-- ========== 00024_dashboard_header_and_birthdays.sql ==========
...
ALTER TYPE score_source_type ADD VALUE IF NOT EXISTS 'birthday_bonus';
